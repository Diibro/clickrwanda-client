...
const NewFreeAdsSection = () => {
     const {data,isLoading, error} = useQuery({queryKey:["newFreeAds"],queryFn:async () => await MainServer.fetch(`${BetaEndpoints.advert}?status=approved&take=12&plan-id=plan_001&by-date=desc&except-categories=b6b8d2d5-476d-48a3-beb0-93f01ecc4ef7,bed1566b-5901-4af9-ae80-708c293aa925`),  staleTime: 0, refetchInterval: 0,refetchOnMount: "always",refetchOnReconnect: true,});
