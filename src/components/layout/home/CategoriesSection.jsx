...
const CategoriesSection = () => {
     const {data,isLoading, error} = useQuery({queryKey:["categories-1"],queryFn:async () => await MainServer.fetch(`${BetaEndpoints.category}`), staleTime: 120000, refetchInterval: 120000,refetchIntervalInBackground: false,refetchOnReconnect: true,});
