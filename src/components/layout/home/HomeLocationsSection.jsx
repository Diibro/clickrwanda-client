...
const HomeLocationsSection = () => {
     ...
     const {data, isLoading, error} = useQuery({queryKey: "adsByLocation-1", queryFn: async() => await MainServer.fetch(`${BetaEndpoints.advert}/locations?locations=${locationStr}`),  staleTime: 120000, refetchInterval: 120000,refetchIntervalInBackground: false, refetchOnReconnect: true,})
