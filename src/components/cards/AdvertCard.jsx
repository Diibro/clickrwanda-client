          ...
          <div className={`w-full border-[1.3px] rounded-[5px] p-[2.5px] relative h-auto flex flex-col gap-[4px] overflow-hidden ${ad.plan_name === 'VIP' ? "border-green-500" : ad.plan_name === "VVIP" ? "border-green-600" : ad.plan_name}-ad ${ad.commission ? 'border-main-primary-gold-500' : 'border-gray-400'}`}>
               ...
               <div className='w-full flex flex-col gap-[2px]'>
                    ...
                    <div className="w-full flex items-center gap-[2.5px] flex-wrap ">
                              ...
                              <a className=' text-[0.65rem] md:text-[0.7rem] text-gray-600 inline-flex items-center gap-[2.5px]' href={`https://www.google.com/maps/place/${capitalizeString(ad.user_location?.location) || "Kigali"}`} target="_blank" rel="noopener noreferrer"><i><FaLocationDot /></i>{ad.user_location?.location || "Kigali"}</a>
