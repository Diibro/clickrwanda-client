...
const QuotationPage = () => {
     ...
     useEffect(() => {
          if(quoteName === 'request quotation') {
               setMessage('RFQ is a solution offered by clickrwanda.com for our buyers seeking multiple quotes for specific products or services.');
          ...
          <div className="page">
               ...
               <div className="quotation-page-body">
                    
                    {
                         ...
                         <>
                              <p>Complete the following form about your {name}.</p>
                              ...
                              <div className="group">
                                   <p><input type="checkbox" required /> I agree to share my {name === "job details" ? "CV" : ''} document with the quoted suppliers </p>
